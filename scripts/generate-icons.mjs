...
// favicon.svg has a 64-unit viewBox: rasterize above the target size so resizes only downscale
const density = 300;

// PNG fallback for browsers/crawlers without SVG favicon support
await sharp(svg, { density }).resize(48, 48).png().toFile(join(publicDir, 'favicon-48.png'));
